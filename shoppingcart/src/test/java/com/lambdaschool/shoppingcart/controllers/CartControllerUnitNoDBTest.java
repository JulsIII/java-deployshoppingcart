...
@WithMockUser(username = "admin",
        roles = {"USER", "ADMIN"})
public class CartControllerUnitNoDBTest
{
    @Autowired
    ...
    public void setUp() throws Exception
    {
        ...
        p1.setProductid(3);
        p3.setName("TEA");
        p3.setDescription("EVERYONE DO TEA");
        p3.setPrice(4.00);
